...
![ReAct 與其他方法的對比](https://raw.githubusercontent.com/hi-im67xuanOuO/Agent-PaperNotes/main/notes/assets/react-fig1-comparison.png)
...
> **Table 1**　知識推理任務各方法表現（HotpotQA 為 Exact Match %，FEVER 為準確率 %）。
...
![FEVER：ReAct 與 CoT-SC 結合最佳](https://raw.githubusercontent.com/hi-im67xuanOuO/Agent-PaperNotes/main/notes/assets/react-fig2-fever-synergy.png)
...
> **Table 2**　互動決策任務成功率：ReAct vs Act-only vs 學習式 baseline。
...
> **Table 3**　HotpotQA 200 例人工分析：ReAct 與 CoT 的幻覺／錯誤類型比例。
...
![HotpotQA：提示 vs 微調的規模結果](https://raw.githubusercontent.com/hi-im67xuanOuO/Agent-PaperNotes/main/notes/assets/react-fig3-scaling-finetune.png)
